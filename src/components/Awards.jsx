...
//   }, []);
  ...
  return (
    <div>
      ...
      {/* Image Card */}
      <div data-aos="flip-down" className="grid grid-cols-1 md:grid-cols-2 lg:flex justify-center">
        <div
          className="w-96 h-96 m-3 text-primary-content image-full"
          style={{
            backgroundImage: `url('https://i.ibb.co/KV434J8/bg1.jpg')`,
        ...
        >
          <div className="text-[#8C94B6]  h-full  flex items-center justify-center text-center ">
            <div>
              ...
              <p className="font-Crimson text-xl px-3">
                Immerse in the magic of our Decor Service. Witness the
                transformation of ordinary spaces into extraordinary visual
                symphonies.
              </p>
              <button className="mt-28 text-gray-500 font-semibold ">
                VIEW MORE
              </button>
            </div>
          </div>
        ...
        <div  data-aos="flip-left"
          className="w-96 h-96 m-3 text-primary-content image-full"
          style={{
            backgroundImage: `url('https://i.ibb.co/kK1Dkhf/bg2.jpg')`,
            backgroundSize: "100% 100%",
          }}
        >
          <div className="text-white  h-full  flex items-center justify-center text-center  ">
            <div>
              <h2 className="text-xl font-bold font-Cormorant mb-5">
                Catering
              </h2>
              <p className="font-Crimson text-xl px-3">
                Savor the flavors with our Catering Service. Delight in
                meticulously crafted dishes that turn any event into a feast.
              </p>
              <button className="mt-28 text-gray-200 font-semibold ">
                VIEW MORE
              </button>
            </div>
          </div>
        ...
        <div data-aos="flip-up"
          className="w-96 h-96 m-3 text-primary-content image-full"
          style={{
            backgroundImage: `url('https://i.ibb.co/sWrDyvy/bg3.jpg')`,
            backgroundSize: "100% 100%",
          }}
        >
          <div className="text-[#8C94B6]  h-full  flex items-center justify-center text-center ">
            <div>
              ...
              <p className="font-Crimson text-xl px-3">
                Experience the rhythm of our Music Collection. Let melody touch
                your heart and harmony unite the world.
              </p>
              <button className="mt-28 text-gray-500 font-semibold ">
                VIEW MORE
              </button>
