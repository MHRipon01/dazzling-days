...
const Contact = () => {
  ...
  return (
    <div>
      <h3 className="text-6xl bg-gradient-to-r  from-pink-500 via-blue-400
...
<form>
   <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
       ...
       <div className="px-4 py-2 flex justify-center pt-6 bg-white rounded-b-lg dark:bg-gray-800">
           ...
           <textarea id="editor" rows="5" className=" w-11/12 flex  text-center items-center pt-20 justify-center px-0 text-sm text-gray-800 bg-white border border-blue-500 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="ADDITIONAL NOTES..." required></textarea>
       </div>
   </div>
          ...
          <div className="form-control flex justify-center items-center mb-20  mt-6">
            <button onClick={handleToast}  className="btn max-w-3xl bg-gradient-to-r  from-pink-500 via-blue-400
     to-indigo-300 text-white">Connect with us</button>
          </div>
        </div>
      </div>
      <ToastContainer />
